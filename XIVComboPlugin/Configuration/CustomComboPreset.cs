...
namespace XIVComboPlugin
{
    ...
    public enum CustomComboPreset : long
    {
        ...
        [CustomComboInfo("AOE连击", "替换超压斧为AOE连击", 21)]
        ...
        [CustomComboInfo("血气改AOE", "替换血气为地毁人亡或秘银暴风", 21, 3)]
        WarriorBloodwhettingCombo = 3L << 0,
        #endregion
        #region SAMURAI
    ...
    {
        internal CustomComboInfoAttribute(string fancyName, string description, byte classJob, byte left = 1)
        {
            FancyName = fancyName;
